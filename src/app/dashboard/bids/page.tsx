...
export default function BidsPage() {
  ...
  const statusStyle = (s: string) => {
    switch (s) { 
      ...
      case 'lost': return 'bg-gray-50 text-gray-400 border-gray-200'; 
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          <div className="flex items-center gap-2 mb-3">
             ...
             <span className="text-sm font-black text-navy/40 uppercase tracking-[0.1em]">Live Participation Feed</span>
          </div>
        ...
        <div className="flex bg-white p-1.5 rounded-xl border border-gray-200 shadow-xl shadow-black/5">
          {tabs.map(tab => (
            <button 
              key={tab} 
              onClick={() => setActiveTab(tab)} 
              className={`px-5 py-2.5 rounded-xl text-sm font-black uppercase tracking-[0.1em] transition-all ${
      ...
      <div className="bg-white rounded-xl p-10 shadow-2xl shadow-black/[0.03] border border-gray-200 relative overflow-hidden">
        ...
        {isLoading ? (
          ...
          <div className="py-32 text-center">
            ...
            <p className="text-sm font-bold text-gray-400 uppercase tracking-[0.1em]">No active participation detected in the current sector</p>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="pb-6 text-sm font-black uppercase tracking-[0.1em] text-gray-400">Target Asset</th>
                  <th className="pb-6 text-sm font-black uppercase tracking-[0.1em] text-gray-400">Strategic Sphere</th>
                  <th className="pb-6 text-sm font-black uppercase tracking-[0.1em] text-gray-400">Your Commitment</th>
                  <th className="pb-6 text-sm font-black uppercase tracking-[0.1em] text-gray-400">Engagement Status</th>
                  <th className="pb-6 text-right text-sm font-black uppercase tracking-[0.1em] text-gray-400">Surveillance</th>
                </tr>
              </thead>
                    ...
                    >
                      <td className="py-8">
                        <div className="flex items-center gap-4">
                          <div className="h-16 w-16 bg-gray-100 rounded-2xl overflow-hidden shrink-0 border border-gray-200 group-hover:scale-105 transition-transform duration-700">
                            <img src={bid.lot?.images?.[0] || '/asset_placeholder.png'} className="w-full h-full object-cover" alt="" />
                          </div>
                          <div>
                      ...
                      <td className="py-8">
                        <p className="text-sm text-gray-300 font-black uppercase tracking-[0.1em] mb-1">Maison Collection</p>
                      ...
                      <td className="py-8">
                        <div className="flex items-center gap-2">
                          ...
                          <PriceDisplay amount={bid.amount} size="lg" variant="navy" align="left" />
                        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
         <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-xl shadow-black/[0.02] group hover:border-gold transition-colors">
         ...
         <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-xl shadow-black/[0.02] group hover:border-burgundy transition-colors">
