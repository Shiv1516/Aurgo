          ...
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <div className="lg:col-span-2 space-y-12">
               <div>
                  <h2 className="text-4xl font-black text-dark tracking-tighter uppercase mb-6 flex items-center gap-4">
                     <Shield className="h-8 w-8 text-burgundy" /> Data Collection
                  </h2>
                  ...
                  <div className="bg-gray-50 p-8 rounded-[2rem] border border-gray-100">
                     <h3 className="text-base font-black text-dark uppercase tracking-widest mb-4">The "Zero-Leach" Guarantee</h3>
               ...
               <div>
                  <h2 className="text-4xl font-black text-dark tracking-tighter uppercase mb-6 flex items-center gap-4">
                     <Database className="h-8 w-8 text-burgundy" /> Storage & Retention
                  </h2>
               ...
               <div>
                  <h2 className="text-4xl font-black text-dark tracking-tighter uppercase mb-6 flex items-center gap-4">
                     <Globe className="h-8 w-8 text-burgundy" /> Cookie Protocol
                  </h2>
                  <p className="text-gray-500 font-medium leading-relaxed">
            ...
            <div className="space-y-8">
               ...
               <div className="p-10 bg-dark rounded-[2.5rem] text-white flex flex-col items-center text-center">
                  ...
                  <Link href="/pages/authentication-process" className="text-sm font-black text-burgundy uppercase tracking-widest underline decoration-2 underline-offset-4">
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-5xl font-black text-dark tracking-tighter uppercase mb-8 leading-tight">
            Security <span className="text-burgundy italic">Matters</span>
          </h2>
