    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative py-32 bg-dark text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <span className="text-burgundy text-sm font-black uppercase tracking-[0.5em] mb-6 block animate-fade-in">Established 2026</span>
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-none uppercase">
            The Soul of <br /><span className="text-burgundy italic">Augeo</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="aspect-square bg-gray-50 rounded-[3rem] overflow-hidden border border-gray-100 p-12">
                 <div className="h-full w-full border-2 border-dashed border-burgundy/20 rounded-[2rem] flex items-center justify-center p-8">
                    <Landmark className="h-32 w-32 text-burgundy opacity-30" />
                 </div>
              </div>
              <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-burgundy rounded-[2rem] flex flex-col items-center justify-center p-6 shadow-2xl shadow-burgundy/20">
                <span className="text-5xl font-black text-dark mb-1">$420M+</span>
                <span className="text-sm font-black text-dark/60 uppercase tracking-widest text-center">Asset Value Settled</span>
              </div>
            </div>

            <div className="space-y-8">
              <h2 className="text-5xl font-black text-dark tracking-tighter uppercase leading-none">
                Our <span className="text-burgundy italic">Origins</span>
              </h2>
              ...
              <div className="pt-4 grid grid-cols-2 gap-8">
                <div>
                   ...
                   <p className="text-sm font-black text-gray-400 uppercase tracking-widest mt-1">Authenticated Listings</p>
                </div>
                <div>
                   <span className="text-3xl font-black text-dark">120+</span>
                   <p className="text-sm font-black text-gray-400 uppercase tracking-widest mt-1">Global Jurisdictions</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-black tracking-tighter mb-4 uppercase">
              The Guild <span className="text-burgundy italic">Principles</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              return (
                <div key={i} className="group p-10 bg-white/5 rounded-[2rem] border border-white/5 hover:border-burgundy/30 hover:bg-white/10 transition-all duration-500">
                  <div className="h-14 w-14 bg-burgundy/10 rounded-2xl flex items-center justify-center mb-8 transform group-hover:scale-110 transition-transform">
      ...
      <section className="py-32 bg-white relative">
         <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-5xl md:text-6xl font-black text-dark tracking-tighter mb-8 uppercase">
               Join the <span className="text-burgundy italic">Executive Council</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
               <Link href="/auth/register" className="btn-primary !px-12 !py-4 uppercase tracking-widest font-black text-sm">
                  Create Membership
               </Link>
               <Link href="/pages/contact" className="px-12 py-4 border border-gray-200 hover:border-burgundy rounded-2xl font-black text-sm uppercase tracking-widest transition-all">
                  Contact Concierge
               </Link>
            </div>
         </div>
