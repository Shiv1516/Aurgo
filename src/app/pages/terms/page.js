    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-24 bg-gray-50 border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-8">Last Updated: February 2026</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-4 gap-12">
            ...
            <div className="hidden lg:block space-y-4 sticky top-32 h-fit">
               <p className="text-[10px] font-black text-gold uppercase tracking-widest mb-6">Agreement Indices</p>
               {[
                 "Guild Membership",
                 "Bidding Sovereignty",
                 ...
                 <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gold/5 transition-colors cursor-pointer group">
                    <span className="text-xs font-bold text-dark">{item}</span>
                    <ChevronRight className="h-3 w-3 text-gray-300 group-hover:text-gold" />
                 </div>
               ))}
               <div className="pt-8 text-center bg-dark rounded-3xl p-6 text-white">
                  <Lock className="h-8 w-8 text-gold mx-auto mb-4" />
                  <p className="text-[10px] font-black uppercase tracking-widest mb-2">Secure Agreement</p>
                  <p className="text-xs text-gray-400 italic">By using this platform, you agree to these protocols.</p>
               </div>
            </div>
            ...
            <div className="lg:col-span-3 space-y-16">
               <article className="prose prose-gold max-w-none">
                  <div className="space-y-8">
                     <section>
                        <h2 className="text-2xl font-black text-dark uppercase tracking-tight mb-4 flex items-center gap-3">
                           <div className="h-6 w-1 bg-gold rounded-full" /> 1. Guild Membership & Eligibility
                        </h2>
                     ...
                     <section>
                        <h2 className="text-2xl font-black text-dark uppercase tracking-tight mb-4 flex items-center gap-3">
                           <div className="h-6 w-1 bg-gold rounded-full" /> 2. Bidding Sovereignty
                        </h2>
                        <p className="text-gray-500 font-medium leading-relaxed mb-4">
                     ...
                     <section>
                        <h2 className="text-2xl font-black text-dark uppercase tracking-tight mb-4 flex items-center gap-3">
                           <div className="h-6 w-1 bg-gold rounded-full" /> 3. Financial Settlement
                        </h2>
                        <p className="text-gray-500 font-medium leading-relaxed">
                     ...
                     <section>
                        <h2 className="text-2xl font-black text-dark uppercase tracking-tight mb-4 flex items-center gap-3">
                           <div className="h-6 w-1 bg-gold rounded-full" /> 4. Intellectual Property
                        </h2>
                        <p className="text-gray-500 font-medium leading-relaxed">
               ...
               <div className="pt-12 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                  <div>
                    <h3 className="text-xl font-black text-dark uppercase mb-2 leading-none">Questions of <span className="text-gold italic">Law?</span></h3>
                    <p className="text-gray-400 font-medium text-sm italic">Our legal council is available for clarification on complex jurisdictional issues.</p>
                  </div>
                  <Link href="/pages/contact" className="btn-primary !px-10 !py-4 uppercase tracking-widest font-black text-xs">
                     Contact Legal Desk
                  </Link>
               </div>
            </div>
