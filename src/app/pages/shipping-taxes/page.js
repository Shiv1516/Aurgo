  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="py-24 bg-dark text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gold/5 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/world-map.png')]" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase leading-none mb-6">
            Logistics & <span className="text-gold italic">Settlement</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <h2 className="text-4xl font-black text-dark tracking-tighter uppercase leading-none">
                The Augeo <span className="text-gold italic">Transit Protocol</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="p-6 bg-gray-50 rounded-3xl border border-gray-100 group hover:border-gold/30 transition-all">
                    <item.icon className="h-6 w-6 text-gold mb-3 group-hover:scale-110 transition-transform" />
                    <h3 className="font-black text-dark uppercase tracking-tight text-sm mb-1">{item.title}</h3>
            ...
            <div className="relative">
               <div className="aspect-square bg-gray-50 rounded-[3rem] overflow-hidden border border-gray-100 p-12">
                  <div className="h-full w-full border-2 border-dashed border-gold/20 rounded-[2rem] flex flex-col items-center justify-center p-8 text-center">
                     <ShieldCheck className="h-32 w-32 text-gold opacity-30 mb-6" />
                     <h3 className="text-2xl font-black text-dark uppercase tracking-tighter">100% Insured Valuations</h3>
                     <p className="text-xs text-gray-400 font-bold mt-2 uppercase tracking-widest">Powered by Lloyd's of London</p>
                  </div>
               </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid lg:grid-cols-3 gap-12">
              <div className="lg:col-span-1">
                 <h2 className="text-3xl font-black text-dark tracking-tighter uppercase mb-6 leading-tight">
                    Jurisdictional <br /><span className="text-gold italic">Compliance</span>
                 </h2>
                 ...
                 <div className="flex items-center gap-4 p-4 bg-white rounded-2xl border border-gray-100 italic font-bold text-xs text-gray-400">
              ...
              <div className="lg:col-span-2 grid md:grid-cols-2 gap-8">
                 {[
                   ...
                   <div key={i} className="p-8 bg-white rounded-[2rem] border border-gray-100 shadow-lg shadow-black/5">
                     <h3 className="text-lg font-black text-dark uppercase tracking-tight mb-4">{tax.region}</h3>
                     <div className="flex gap-10 mb-6">
                        <div>
                           <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Import Duty</p>
                           <p className="text-xl font-black text-gold mt-1">{tax.duty}</p>
                        </div>
                        <div>
                           <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">VAT/GST</p>
                           <p className="text-xl font-black text-dark mt-1">{tax.vat}</p>
                        </div>
                     </div>
                     <p className="text-xs text-gray-400 font-medium leading-relaxed italic border-t border-gray-50 pt-4">
                       {tax.note}
                     </p>
                   </div>
                 ))}
      ...
      <section className="py-32">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-black text-dark tracking-tighter uppercase mb-8 leading-tight">
            Tailored <span className="text-gold italic">Logistics Quotation</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Link href="/pages/buyers-premium" className="px-12 py-4 border border-gray-200 hover:border-gold rounded-2xl font-black text-xs uppercase tracking-widest transition-all">
               View Fee Schedule
            </Link>
          </div>
        </div>
